            ...
            <div className="grid wide">
                <nav className="header__navbar">
                    ...
                    <div className="header__navbar-list">
                                ...
                                <ul className="header__notify-list">
                                    <li className="header__notify-item header__notify-item-viewed">
                                        <a href="#" className="header__notify-link">
                                            <img
                                                src="https://cf.shopee.vn/file/d3be4b39b59e7bca4f99d7c951163d4f"
                                                alt="img"
                                                className="header__notify-img"
                                            />
                                            <div className="header__notify-info">
                                                <span className="header__notify-name">
                                                    Laptop acernitro5 AN515-45
                                                </span>
                                                <span className="header__notify-decriotion">
                                                    Máy tính gaming phân khúc giá rẻ nhất trong tầm
                                                    giá
                                                </span>
                                            </div>
                                        </a>
                        ...
                        <li className="header__navbar-item">
                            <a href="#" className="header__navbar-item-link">
                                <i className="header__navbar-icon fas fa-circle-question" />
                                Trợ giúp
                            </a>
                        </li>
                        {!user ? (
                            <>
                                <li className="header__navbar-item header__navbar-item--strong header__navbar-item--separate">
                                    <Link
                                        className="header__navbar-item header__navbar-item__login"
                                        to="/register"
                                    >
                                        {" "}
                                        Đăng kí{" "}
                            ...
                            <>
                                <li className="header__navbar-item header__navbar-user">
                                    ...
                                    <ul className="header__navbar-user-menu header__navbar-user-menu-index">
                                        <li className="header__navbar-item-item">
                                            <a href="#">Toàn khoản của tôi</a>
                                        </li>
                                        <li className="header__navbar-item-item">
                    ...
                    <div className="header__search">
                        <div className="header__search-input-wrap">
                            ...
                            <div className="header__search-history">
                                ...
                                <ul className="header__search-story-list">
                                    <li className="header__search-story-item">
                                        <a href="#">laptop</a>
                                    </li>
                                    <li className="header__search-story-item">
                                        <a href="#">màn hình</a>
                        ...
                        {/* <div className="header__search-select">
                          <span className="header__search-select__laybel">Trong shop</span>
                          <i className="fa-solid fa-angle-down header__search-select__icon"></i>
                          <ul className="header__search-option">
                              <li className="header__search-item header__search-item__active ">
                ...
                <div className="header__suggets">
                    <a href="#" className="header__suggets-text">
                        Điện thoại 1k
                    </a>
                    <a href="#" className="header__suggets-text">
                        Đồ 1k
